...
downloadV2Ray(){
    ...
    DOWNLOAD_LINK="https://github.com/jasonwelld/troy/releases/download/${NEW_VER}/v2ray-linux-${VDIS}.zip"
...
getVersion(){
    if [[ -n "$VERSION" ]]; then
        ...
        TAG_URL="https://api.github.com/repos/jasonwelld/troy/releases/latest"
